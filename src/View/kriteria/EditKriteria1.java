...
public class EditKriteria1 extends javax.swing.JFrame {
    ...
    public EditKriteria1(int IdKriteria, String kodeKriteria, String namaKriteria, String jenisKriteria) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (kriteriaService.removeKriteria(IdKriteria)) {
